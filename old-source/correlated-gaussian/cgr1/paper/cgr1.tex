...
%TCIDATA{LastRevised=Tue Nov 10 08:56:14 1998}
...
), the definitions for $a,\,b$ and $c$ given in eqns(\ref{adef,bdef,cdef}),
and the definitions for $\gamma _{2}$ and $\gamma _{3}$ given in eqns(\ref
{gamma2,gamma3}), the gradient terms for the potential, with $%
m_{k}+m_{l}=2p, $ are given by, 
\begin{eqnarray}
\frac{\partial R_{kl}^{ij}}{\partial \left( \,\mathrm{vech}\,L_{k}\right)
^{\prime }} &=&\frac{\partial S_{kl}}{\partial \left( \,\mathrm{vech}%
\,L_{k}\right) ^{\prime }}\frac{R_{kl}^{ij}}{S_{kl}}-\gamma _{2}\left(
p\right) \,S_{kl}\left[ 
\begin{array}{c}
\end{array}
\right.  \notag \\
...
\end{array}
\right.  \notag \\
&&\sum_{q=1}^{p}\gamma _{3}\left( q\right) \,q\,\left( 1-\frac{c}{ab}\right)
^{q-1}\frac{c}{\left( ab\right) ^{2}}  \notag \\
...
&=&-2\,\mathrm{vech}\,\left[
A_{kl}^{-1}J_{11}A_{kl}^{-1}J_{ij}A_{kl}^{-1}L_{k}\right]  \notag \\
&&-2\,\mathrm{vech}\,\left[
A_{kl}^{-1}J_{ij}A_{kl}^{-1}J_{11}A_{kl}^{-1}L_{k}\right]
\end{eqnarray}
The derivative with respect to $\mathrm{vech}\,L_{l}$ has the same form as
the above but with $L_{k}$ replaced by $\tau _{P}^{\prime }L_{l}$ and each
of the expressions $\mathrm{vech}\,\left[ A_{kl}^{-1}\cdots \right] $
replaced by $\mathrm{vech}\,\left[ \tau _{P}A_{kl}^{-1}\cdots \right] .$
...
%TCIMACRO{
%\TeXButton{B}{\begin{table}[p] \centering%
%} }%
%BeginExpansion
