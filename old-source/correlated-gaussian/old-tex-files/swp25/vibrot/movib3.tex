...
To model the physical systems, {\it i.e.}, write the Hamiltonian, particles
...
Let ${\bf R}$ be the vector of particle coordinates in the laboratory fixed
reference frame. 
\begin{equation}
{\bf R=}\left[ 
\begin{array}{c}
...
\begin{equation}
Y_{LM}^k=\sum_{\,\,%
%TCIMACRO{\QATOPD. . {\left\{ l_j,m_j\right\} }{m_1+\cdots +m_n=M}}
%BeginExpansion
