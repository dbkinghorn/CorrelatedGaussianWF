...
c----------------------------------------------------------------------
      ...
      SUBROUTINE A21VM(N,B,BH,NBH,X,C,G,T,IFN,IG,IPR,P0,FGRAD)
...
C     FOR RESTARTS AFTER A MAJOR ITERATION
      OPEN( UNIT=10, FILE='VMRESTRT.PT', STATUS='UNKNOWN' )
      DO I=1,N
            WRITE(10,*) X(I)
      END DO
